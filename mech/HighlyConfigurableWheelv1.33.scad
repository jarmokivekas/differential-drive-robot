...
tireCSDiameter = 0;     // Cross-sectional diameter (CS) -- How thick is the tire rubber?
tireID         = 70;    // Internal diameter (ID) -- How wide is the inside opening? 
...
vaneLength		= 3;			// Length of vanes
vaneOffset		= 9;			// Offset into wheel of vanes
...
knobSize          = [40,1.5,1];   // The size of each knob [across wheel, along the perimeter, prodruding]
...
spokeStyle        = "line";   // none, biohazard, circle, circlefit, diamond, line, rectangle, spiral, fill
...
hubDiameter          = 22;    // The diameter of the hub portion of the wheel
hubHeight            = 20;    // The total height of the hub
hubZOffset           = -8;     // The Z position of the hub, negative numbers from the surface of the wheel 
innerCircleDiameter  = 26;    // The diameter of the solid inner circle under the hub, or zero for none. 

baseFilletRadius     = 0;     // The radius of the fillet (rounded part) between the hub and wheel. 
topFilletRadius      = 1;     // The radius of the fillet (rounded part) at the top of the hub. 
chamferOnly          = true; // Set to true to use chamfers (straight 45-degree angles) instead of fillets. 
...
shaftDiameter        = 5;          // The diameter of the motor shaft
shaftFlatDiameter    = shaftDiameter;          // The diameter of the motor shaft at the flat, or shaftDiameter for no flat.

setScrewCount        = 2;          // The number of set screws/nuts to render, spaced evenly around the shaft 
setScrewDiameter     = 4 ;          // The diameter of the set screw. 3 is the default for an M3 screw. 
setScrewTrap         = [6, 3.3]; // Size [indiameter, thickness] of set screw nut. The depth is set automatically.
setScrewNutDiameter  = 6;        // The "diameter" of the captive nut, from flat to flat (the "in-diameter")
setScrewNutThickness = 3.0;        // The thickness of the captive nut
